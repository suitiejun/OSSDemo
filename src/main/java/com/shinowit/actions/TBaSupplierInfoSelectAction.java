 ...
 */
public class TBaSupplierInfoSelectAction {
    @Resource
    ...
    public String select(){
        ...
        if (text!=null){
            ...
            list=dao.queryForPage(" from  TBaSupplierInfoEntity t where t.supplierName like \'%" + text + "%\'",page,limit);
            rows=dao.queryRecordCount(" select count(*) from  TBaSupplierInfoEntity t where t.supplierName like  \'%" + text + "%\'");
            return "ok";
        }
        list=dao.queryForPage(" from  TBaSupplierInfoEntity ",page,limit);
